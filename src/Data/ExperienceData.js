...
export const ExperienceData = [
  {
    ...
    Description:
      "Datahub project: An enterprise system in order to integrate the business data from multiple applications " +
    ...
    Technologies:
      ".Net Framework, EF, WCF, Win Service, Microservice and MS-SQL Server.",
...

  {
    ...
    Description:
      ...
      " responsible for UML designing, data modeling, developing Web-Site and Web-API. The result was satisfying.",
    Technologies: "Java, Spring, Hibernate ORM, Thymeleaf, Bootstrap.",
...

  {
    ...
    Technologies: " Asp.NET, Ms-Sql Server, Entity Framework and DevExpress.",
...

  {
    ...
    Technologies: "Asp.net MVC, Highcharts.js and DevExtreme, Bootstrap...",
